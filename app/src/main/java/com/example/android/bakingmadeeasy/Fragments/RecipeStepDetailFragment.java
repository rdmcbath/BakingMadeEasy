...
/**
 * Created by Rebecca on 5/24/2017. This fragment is for the RecipeDetail UI screen and should show
 * the video and detailed description of a step in the recipe.
 */
...
public class RecipeStepDetailFragment extends Fragment implements ExoPlayer.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (recipeStepList != null) {
            ...
            if (!TextUtils.isEmpty(recipeStepList.get(position).getThumbnailURL()))
                Picasso.get()
                        .load(recipeStepList.get(position)
                        .getThumbnailURL())
                        .into(thumbnail);
